<template>
  <Panel title="in推荐" :class="$style.panel">
      <section :class="$style.content">
          <section :class="$style.item" v-for="(item, index) in items" :key="index">
              <img :src="item.catory" alt="">
              <section :class="$style.list">
                  <div :class="$style.product" v-for="(product, index) in item.product" :key="index">
                      ...
                      <label for="" v-if="product.choiceness">精选</label>
                  </div>
              </section>
          </section>
      </section>
